...
public class GameBoard extends JPanel implements KeyListener {
    ...
    private static final Color BG_COLOR = new Color(205, 232, 233);
    private static final Color BOARD_BG_COLOR = new Color(187, 211, 214);
    private static final Color TILE_COLOR = new Color(187, 211, 214);
    private static final Color TILE_COLOR_LARGE = new Color(187, 211, 214);
    ...
    public GameBoard() {
        ...
        tryAgain.setBounds(350 - 45, 270 + 70, 90, 40);
        add(tryAgain);
        tryAgain.setVisible(false);
        ...
        newGame.setBounds(350 - 45, 270 + 70, 90, 40);
        add(newGame);
        newGame.setVisible(false);
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.fillRoundRect(0, 0, 600, 600, 6, 6);
        ...
        for (int row = 0; row < board.length; row++) {
            for (int col = 0; col < board[0].length; col++) {
                ...
                int yPosition = 0 + (row * 120) + ((row + 1) * SPACING);
    ...
    public Color getTileBackground(int value) {
        switch (value) {
            ...
            case 2:
                return new Color(205, 232, 233);
            case 4:
                return new Color(169, 107, 247);
            case 8:
                return new Color(97, 160, 234);
            case 16:
                return new Color(246, 150, 100);
            case 32:
                return new Color(131, 107, 234);
            case 64:
                return new Color(164, 72, 245);
            case 128:
                return new Color(218, 100, 243);
            case 256:
                return new Color(242, 78, 247);
            case 512:
                return new Color(247, 78, 170);
            case 1024:
                return new Color(247, 78, 119);
            case 2048:
                return new Color(199, 40, 40);
            default:
                return new Color(205, 193, 180);
        }
    }
